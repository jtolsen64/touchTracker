...
//  touchTracker
//
//  Created by Jayden Olsen on 4/3/17.
...
class DrawView: UIView, UIGestureRecognizerDelegate {
    ...
    func tap(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if selectedLineIndex != nil {
            ...
            //Make DrawView the targetof menu item action messages
    ...
    func moveLine(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        if let index = selectedLineIndex {
            ...
            if gestureRecognizer.state == .changed {
                ...
                //Add the translation to the correct beginning and end points of the line
    ...
    func indexOfLine(at point: CGPoint) -> Int? {
        ...
        //If nothing ia close enough to tapped point, then we did not select a line
        return nil
    }
